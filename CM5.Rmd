...
color_map <- c("Vehicle" = "#999999", "MK-8722" = "#B20237", "Survodutide" = "#918AE1", "Chow-vehicle" = "#E5E7EA", "JOP63" = "#13D6B0")
group_levels <- c("Chow-vehicle", "Vehicle", "MK-8722", "JOP63", "Survodutide")
...
BG_file <- "/Users/christoffermerrild/OneDrive - University of Copenhagen/Speciale/CM5/CM5-BG.xlsx"
...
```{r BM, echo=FALSE}
# Define the path to your Excel file
BM_file <- "/Users/christoffermerrild/OneDrive - University of Copenhagen/Speciale/CM5/CM5-BM1.xlsx"
...
BM_plot <- ggplot(relevel(summary_BM, "Treatment"), aes(x = Timepoint, y = Mean, color = Treatment, group = Treatment)) +
  ...
  scale_x_continuous(breaks = seq(-6, 39, by = 3)) +
  labs(
    x = "Time (days)",
    y = "Mean weight (g)",
  ...
  minimal_theme +
  coord_cartesian(xlim = c(0, max(summary_BM$Timepoint)), ylim = c(15, 40))
...
BM_total_barplot <- ggplot(data = relevel(BM_total_loss_treatment, "Treatment"), aes(x = Treatment, y = Loss, fill = Treatment)) +
  ...
  scale_y_continuous(n.breaks = 8, expand = expansion(mult = 0)) + 
  minimal_theme +
...
BM_delta_total_barplot <- ggplot(data = relevel(delta_total_BM, "Treatment"), aes(x = Treatment, y = Delta_BM, fill = Treatment)) +
  ...
  scale_y_continuous(n.breaks = 6, expand = expansion(mult = 0)) + 
...
```{r FI, echo=FALSE}
# Define the path to your Excel file
FI_file <- "/Users/christoffermerrild/OneDrive - University of Copenhagen/Speciale/CM5/CM5-FI1.xlsx"
...
FI_plot <- ggplot(relevel(summary_FI, "Treatment"), aes(x = Timepoint, y = Mean, color = Treatment, group = Treatment)) +
  ...
  geom_errorbar(aes(ymin = Mean - SE, ymax = Mean + SE), width = 0.2, linewidth = 0.3) +
  scale_color_manual(values = color_map) +
  scale_x_continuous(breaks = seq(0, 39, by = 3)) +
  labs(
    x = "Time (days)",
    y = "Food intake (kcal)",
...
SampleIDs <- read_excel("CM5_sampleIDs.xlsx") %>% 
...
MRI_delta_fat_barplot <- ggplot(data = relevel(MRI_fat_delta, "Treatment"), aes(x = Treatment, y = delta, fill = Treatment)) +
  ...
  scale_y_continuous(n.breaks = 10, expand = expansion(mult = 0)) + 
...
# Define the path to your Excel file
necropsy_file <- "/Users/christoffermerrild/OneDrive - University of Copenhagen/Speciale/CM5/CM5-Necropsy.xlsx"
...
```{r plots, echo=FALSE}
ggsave("CM5-JOP63_FI.png", FI_plot, width = 6, height = 4, dpi = 300, bg = "white")
ggsave("CM5-JOP63_FI_total_barplot.png", FI_total_barplot, width = 6, height = 4, dpi = 300, bg = "white")
ggsave("CM5-JOP63_BM.png", BM_plot, width = 6, height = 4, dpi = 300, bg = "white")
ggsave("CM5-JOP63_BM_delta.png", BM_delta_plot, width = 6, height = 4, dpi = 300, bg = "white")
ggsave("CM5-JOP63_BM_delta_total.png", BM_delta_total_barplot, width = 6, height = 4, dpi = 300, bg = "white")
ggsave("CM5-JOP63_BM_total.png", BM_total_barplot, width = 6, height = 4, dpi = 300, bg = "white")
ggsave("CM5-JOP63_BG.png", BG_plot, width = 6, height = 4, dpi = 300, bg = "white")
...
ggsave("CM5-JOP63_AST.png", ast_plot, width = 6, height = 4, dpi = 300, bg = "white")
ggsave("CM5-JOP63_ALT.png", alt_plot, width = 6, height = 4, dpi = 300, bg = "white")
ggsave("CM5-JOP63_chol.png", chol_plot, width = 6, height = 4, dpi = 300, bg = "white")
ggsave("CM5-JOP63_trig.png", trig_plot, width = 6, height = 4, dpi = 300, bg = "white")
...
ggsave("CM5-JOP63_MRI_delta_lean.png", MRI_delta_lean_barplot, width = 6, height = 4, dpi = 300, bg = "white")
ggsave("CM5-JOP63_MRI_delta_lean2.png", MRI_delta_lean_barplot2, width = 6, height = 4, dpi = 300, bg = "white")
ggsave("CM5-JOP63_MRI_lean.png", MRI_lean_barplot, width = 6, height = 4, dpi = 300, bg = "white")
ggsave("CM5-JOP63_MRI_delta_fat.png", MRI_delta_fat_barplot, width = 6, height = 4, dpi = 300, bg = "white")
ggsave("CM5-JOP63_MRI_delta_fat2.png", MRI_delta_fat_barplot2, width = 6, height = 4, dpi = 300, bg = "white")
ggsave("CM5-JOP63_MRI_fat.png", MRI_fat_barplot, width = 6, height = 4, dpi = 300, bg = "white")
...
# svgs
ggsave("CM5-JOP63_FI.svg", FI_plot, width = 7, height = 4, device = "svg")
ggsave("CM5-JOP63_FI_total_barplot.svg", FI_total_barplot, width = 4, height = 4, device = "svg")
ggsave("CM5-JOP63_FI_cumulative.svg", FI_cumulative_plot, width = 7, height = 4, device = "svg")
ggsave("CM5-JOP63_BM.svg", BM_plot, width = 7, height = 4, device = "svg")
ggsave("CM5-JOP63_BM_delta.svg", BM_delta_plot, width = 7, height = 4, device = "svg")
ggsave("CM5-JOP63_BM_delta_total.svg", BM_delta_total_barplot, width = 4.5, height = 4, device = "svg")
ggsave("CM5-JOP63_BM_total.svg", BM_total_barplot, width = 4.5, height = 4, device = "svg")
ggsave("CM5-JOP63_BG.svg", BG_plot, width = 4, height = 5, device = "svg")
ggsave("CM5-JOP63_BG_change.svg", final_BG_barplot, width = 4, height = 4, device = "svg")

ggsave("CM5-JOP63_MRI_delta_lean.svg", MRI_delta_lean_barplot, width = 4, height = 4, device = "svg")
ggsave("CM5-JOP63_MRI_delta_lean2.svg", MRI_delta_lean_barplot2, width = 4.5, height = 4, device = "svg")
ggsave("CM5-JOP63_MRI_lean.svg", MRI_lean_barplot, width = 6, height = 4, device = "svg")
ggsave("CM5-JOP63_MRI_delta_fat.svg", MRI_delta_fat_barplot, width = 4, height = 4, device = "svg")
ggsave("CM5-JOP63_MRI_delta_fat2.svg", MRI_delta_fat_barplot2, width = 4.5, height = 4, device = "svg")
ggsave("CM5-JOP63_MRI_fat.svg", MRI_fat_barplot, width = 6, height = 4, device = "svg")
ggsave("CM5-JOP63_liver.svg", liver_barplot, width = 4, height = 4, device = "svg")
