...
comparisons <- list(c("Vehicle", "MK-8722"), c("Vehicle", "JOP54"), c("Vehicle", "JOP63"))
comparisons2 <- list(c("Vehicle", "MK-8722"), c("Vehicle", "JOP54"), c("Vehicle", "JOP63"),
                    c("MK-8722", "JOP54"), c("MK-8722", "JOP63"),
                    c("JOP54", "JOP63"))
color_map <- c("JOP54" = "#38C7E8", "MK-8722" = "#FC827F", "JOP63" = "#045456", "Vehicle" = "#999999")
...
ctt_file <- "/Users/christoffermerrild/OneDrive - University of Copenhagen/Speciale/CM2/CM2-JOP63_CTT.xlsx"
...
# Define the path to your Excel file
final_BG_file <- "/Users/christoffermerrild/OneDrive - University of Copenhagen/Speciale/CM2/CM2-JOP63_final_BG.xlsx"
...
final_BG_barplot <- ggplot(data = relevel(final_BG_data, "Treatment"), aes(x = Treatment, y = BG, fill = Treatment)) +
  ...
  labs(y = "Blood glucose (mmol/L)",
       title = "Final blood glucose vs. Treatment (day 7)",
...
```{r gubra, echo=FALSE}
# Define the path to your Excel file
gubra_file <- "/Users/christoffermerrild/OneDrive - University of Copenhagen/Speciale/CM2/JOP63_GUBRA_lean.xlsx"
...
```{r BM, echo=FALSE}
# Define the path to your Excel file
BM_file <- "/Users/christoffermerrild/OneDrive - University of Copenhagen/Speciale/CM2/CM2-JOP63_BM.xlsx"
...
BM_plot <- ggplot(relevel(summary_BM, "Treatment"), aes(x = Timepoint, y = Mean, color = Treatment, group = Treatment)) +
  ...
  minimal_theme +
  coord_cartesian(xlim = c(0, max(summary_BM$Timepoint)), ylim = c(20, 30))
...
```{r FI, echo=FALSE}
# caloric value of chow diet (D12331i, ResearchDiets)
kcal_chow <- 3.339

# Define the path to your Excel file
FI_file <- "/Users/christoffermerrild/OneDrive - University of Copenhagen/Speciale/CM2/CM2-JOP63_FI.xlsx"
...
FI_plot <- ggplot(relevel(summary_FI, "Treatment"), aes(x = Timepoint, y = Mean, color = Treatment, group = Treatment)) +
  ...
  minimal_theme +
  coord_cartesian(xlim = c(0, 7), ylim = c(5, 20))
...
FI_cumulative_plot <- ggplot(summary_FI_cumulative, aes(x = Timepoint, y = Mean, color = Treatment, group = Treatment)) +
  ...
  minimal_theme +
  coord_cartesian(xlim = c(0, 7), ylim = c(0, max(summary_FI_cumulative$Mean) + 50))
...
# Define the path to your Excel file
chol_file <- "/Users/christoffermerrild/OneDrive - University of Copenhagen/Speciale/CM2/20231121_Chol_data.xlsx"
...
SampleIDs <- read_excel("20231121_sampleID.xlsx")
...
# Define the path to your Excel file
trig_file <- "/Users/christoffermerrild/OneDrive - University of Copenhagen/Speciale/CM2/20231121_Trig_data.xlsx"
...
ast_file <- "/Users/christoffermerrild/OneDrive - University of Copenhagen/Speciale/CM1/20231128-CM1_AST_data2.xlsx"
...
ast_deltaA_min <- ast_data %>%
  ...
  mutate(U_L = abs((deltaA_min/0.00622) * (100/2))) %>%
  filter(grepl("^#2", SampleID)) %>%
  filter(R2 >= cutoff) 
...
#### THis is ALT assay
alt_file <- "/Users/christoffermerrild/OneDrive - University of Copenhagen/Speciale/CM1/20231211_ALT-2-data.xlsx"
...
```{r qPCR-data}
# .txts 
qPCR_file_path <- "20231130_qPCR_CM2_1.txt"
qPCR_file_path2 <- "20231130_qPCR_CM2_2.txt"

# .xlxs
long_format_file_path <- "20231130_CM2_qPCR_sampleID.xlsx"
long_format_file_path2 <- "20231130_CM2_qPCR_sampleID2.xlsx"
...
annotation_data <- summary_qPCR_results %>%
  dplyr::select(Gene, Test_Used, Overall_p_value) %>%
  filter(!is.na(Test_Used)) %>%
  distinct()

# Prepare a dataset for annotations
annotation_data2 <- summary_qPCR_results2 %>%
  dplyr::select(Gene, Test_Used, Overall_p_value) %>%
  filter(!is.na(Test_Used)) %>%
  distinct()
...
ggsave("JOP63_CM2_FI.svg", FI_plot, width = 6, height = 4, device = 'svg')
ggsave("JOP63_CM2_BM.svg", BM_plot, width = 6, height = 4, device = 'svg')
ggsave("JOP63_CM2_BM_delta.svg", BM_delta_plot, width = 6, height = 4, device = 'svg')
ggsave("JOP63_CM2_BM_delta_total_barplot.svg", BM_delta_total_barplot, width = 4, height = 4, device = 'svg')
ggsave("JOP63_CM2_BM_total_barplot.svg", BM_total_barplot, width = 4, height = 4, device = 'svg')
ggsave("JOP63_CM2_FI_total_barplot.svg", FI_total_barplot, width = 4, height = 4, device = 'svg')
ggsave("JOP63_CM2_FI_cumulative_plot.svg", FI_cumulative_plot, width = 4, height = 4, device = 'svg')
ggsave("JOP63_CM2_gubra_barplot.svg", gubra_barplot, width = 4, height = 4, device = 'svg')
ggsave("JOP63_CM2_qPCR_barplot.svg", qPCR_barplot, width = 6, height = 4, device = 'svg')
ggsave("JOP63_CM2_qPCR_barplot2.svg", qPCR_barplot2, width = 6, height = 4, device = 'svg')
ggsave("JOP63_CM2_qPCR_FC_barplot.svg", qPCR_FC_barplot, width = 6, height = 4, device = 'svg')
ggsave("JOP63_CM2_qPCR_FC_barplot2.svg", qPCR_FC_barplot2, width = 6, height = 4, device = 'svg')
ggsave("JOP63_CM2_ctt.svg", ctt_plot, width = 6, height = 4, device = 'svg')
ggsave("JOP63_CM2_final_BG_barplot.svg", final_BG_barplot, width = 4, height = 4, device = 'svg')
ggsave("JOP63_CM2_alt_barplot.svg", alt_barplot, width = 4, height = 4, device = 'svg')
ggsave("JOP63_CM2_ast_barplot.svg", ast_barplot, width = 4, height = 4, device = 'svg')
ggsave("JOP63_CM2_chol_barplot.svg", chol_barplot, width = 4, height = 4, device = 'svg')
ggsave("JOP63_CM2_GDF15_barplot.svg", GDF15_barplot, width = 4, height = 4, device = 'svg')
ggsave("JOP63_CM2_trig_barplot.svg", trig_barplot, width = 4, height = 4, device = 'svg')
